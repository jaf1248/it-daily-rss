...
- [CVE-2026-39821 Invoking failure to reject ASCII-only Punycode-encoded labels in golang.org/x/net/idna](https://msrc.microsoft.com/update-guide/vulnerability/CVE-2026-39821)  
  **Microsoft Security Response Center (MSRC)** · Jun 01 · _General awareness item._  
